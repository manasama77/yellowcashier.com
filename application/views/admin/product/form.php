...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="<?=site_url();?>admin/product/create"><i class="fa fa-plus"></i> Tambah Produk</a></li>
	</ol>
</section>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-info">
				...
				<form class="form-horizontal" method="post" action="<?=site_url();?>admin/product/create">
					<div class="box-body">

						<div class="form-group">
							<label for="barcode" class="col-sm-2 control-label">Barcode</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="barcode" name="barcode" placeholder="Barcode" minlength="3" maxlength="100" value="<?=set_value('barcode');?>" required autofocus>
								<?=form_error('barcode');?>
							</div>
						</div>
